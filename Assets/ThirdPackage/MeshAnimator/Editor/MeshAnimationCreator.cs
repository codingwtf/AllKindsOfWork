...
namespace FSG.MeshAnimator
{
    ...
    public class MeshAnimationCreator : EditorWindow
    {
        ...
        [SerializeField]
        private Snapshot.SnapshotMeshNormalMode meshNormalMode = Snapshot.SnapshotMeshNormalMode.UseOriginal;
        [SerializeField]
                ...
                if (prefab != null)
                {
                    ...
                    using (RenderSection.Draw("Bake Preferences", bgs[0], () =>
                    {
                        ...
                        if (selectedAnimatorType == MeshAnimatorType.Snapshot)
                        {
                            ...
                            List<string> meshNormalOptions = System.Enum.GetNames(typeof(Snapshot.SnapshotMeshNormalMode)).ToList();
                            int meshNormalIndex = 0;
                            for (int i = 0; i < 3; i++)
                            {
                                if (meshNormalMode == (Snapshot.SnapshotMeshNormalMode)i)
                                {
                                    meshNormalIndex = i;
                                    break;
                                }
        ...
        private void LoadPreferencesForAsset()
        {
            try
            {
                ...
                meshNormalMode = (Snapshot.SnapshotMeshNormalMode)bakePrefs.meshNormalMode;
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (animator != null)
                    {
                        ...
                        animator.applyRootMotion = rootMotionMode == RootMotionMode.Baked;
                    }
