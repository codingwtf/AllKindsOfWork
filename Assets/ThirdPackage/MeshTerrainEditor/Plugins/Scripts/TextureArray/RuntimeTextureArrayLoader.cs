...
namespace MTE
{
    ...
    public class RuntimeTextureArrayLoader : MonoBehaviour
    {
        ...
        private void Start()
        {
...
#endif
            if (settings.textureMode == TextureArrayMode.PBRWithMetallic)
            {
            ...
            switch (settings.textureMode)
            {
                ...
                case TextureArrayMode.PBR:
                    ...
                    break;
                case TextureArrayMode.PBRWithMetallic://This mode is not implemented. If you need it, please see the docs on how to contact support and submit a feature request.
                    throw new System.NotImplementedException();
                    #if false
                    meshRenderer.sharedMaterial.SetTexture(
                        TextureArrayShaderPropertyNames.AlbedoMetallicArrayPropertyName, array0);
                    meshRenderer.sharedMaterial.SetTexture(
                        TextureArrayShaderPropertyNames.RoughnessNormalAOArrayPropertyName, array1);
                    #endif
                    break;
        ...
        public void UnloadInEditor()
        {
            ...
            switch (settings.textureMode)
            {
                ...
                case TextureArrayMode.PBR:
                    ...
                    break;
                case TextureArrayMode.PBRWithMetallic://TODO not supported, don't use this mode.
                    meshRenderer.sharedMaterial.SetTexture(
                        TextureArrayShaderPropertyNames.AlbedoMetallicArrayPropertyName, null);
                    meshRenderer.sharedMaterial.SetTexture(
                        TextureArrayShaderPropertyNames.RoughnessNormalAOArrayPropertyName, null);
                    break;
                default:
            ...
            out Texture2DArray array0, out Texture2DArray array1)
        {
            ...
            else if(settings.textureMode == TextureArrayMode.PBR)
            {
            ...
            {
                throw new System.NotImplementedException($"TextureMode {settings.textureMode} hasn't been implemented.");
            }
            ...
            out Texture2DArray albedoArray, out Texture2DArray roughNormalAOArray)
        {
            ...
            //create Albedo texture array 
            {
                ...
                //TODO support metallic at Albedo alpha channel
            }
        ...
        {
            Texture2D result = new Texture2D(textureSize, textureSize, TextureFormat.RGBA32, true, true);
