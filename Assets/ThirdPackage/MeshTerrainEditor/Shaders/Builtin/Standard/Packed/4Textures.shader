...
#define _Smoothness_arr MTEStandardExperimentalPacked4Textures
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 temp_output_94_0_g112 = uv_PackedHeightMap;
			float2 appendResult99_g112 = (float2(_PackedHeightMap_TexelSize.x , 0.0));
			float4 tex2DNode97_g112 = tex2D( _PackedHeightMap, ( temp_output_94_0_g112 + appendResult99_g112 ) );
			float4 tex2DNode100_g112 = tex2D( _PackedHeightMap, temp_output_94_0_g112 );
			float temp_output_21_0_g113 = tex2DNode100_g112.r;
			float temp_output_128_0_g112 = _NormalStrength.x;
			float temp_output_22_0_g113 = temp_output_128_0_g112;
			float3 appendResult11_g113 = (float3(1.0 , 0.0 , ( ( tex2DNode97_g112.r - temp_output_21_0_g113 ) * temp_output_22_0_g113 )));
			float2 appendResult101_g112 = (float2(0.0 , _PackedHeightMap_TexelSize.y));
			float4 tex2DNode98_g112 = tex2D( _PackedHeightMap, ( temp_output_94_0_g112 + appendResult101_g112 ) );
			float3 appendResult19_g113 = (float3(0.0 , 0.5 , ( ( tex2DNode98_g112.r - temp_output_21_0_g113 ) * temp_output_22_0_g113 )));
			float3 normalizeResult15_g113 = normalize( cross( appendResult11_g113 , appendResult19_g113 ) );
			float temp_output_21_0_g115 = tex2DNode100_g112.g;
			float temp_output_22_0_g115 = temp_output_128_0_g112;
			float3 appendResult11_g115 = (float3(1.0 , 0.0 , ( ( tex2DNode97_g112.g - temp_output_21_0_g115 ) * temp_output_22_0_g115 )));
			float3 appendResult19_g115 = (float3(0.0 , 0.5 , ( ( tex2DNode98_g112.g - temp_output_21_0_g115 ) * temp_output_22_0_g115 )));
			float3 normalizeResult15_g115 = normalize( cross( appendResult11_g115 , appendResult19_g115 ) );
			float temp_output_21_0_g116 = tex2DNode100_g112.b;
			float temp_output_22_0_g116 = temp_output_128_0_g112;
			float3 appendResult11_g116 = (float3(1.0 , 0.0 , ( ( tex2DNode97_g112.b - temp_output_21_0_g116 ) * temp_output_22_0_g116 )));
			float3 appendResult19_g116 = (float3(0.0 , 0.5 , ( ( tex2DNode98_g112.b - temp_output_21_0_g116 ) * temp_output_22_0_g116 )));
			float3 normalizeResult15_g116 = normalize( cross( appendResult11_g116 , appendResult19_g116 ) );
			float temp_output_21_0_g114 = tex2DNode100_g112.a;
			float temp_output_22_0_g114 = temp_output_128_0_g112;
			float3 appendResult11_g114 = (float3(1.0 , 0.0 , ( ( tex2DNode97_g112.a - temp_output_21_0_g114 ) * temp_output_22_0_g114 )));
			float3 appendResult19_g114 = (float3(0.0 , 0.5 , ( ( tex2DNode98_g112.a - temp_output_21_0_g114 ) * temp_output_22_0_g114 )));
			float3 normalizeResult15_g114 = normalize( cross( appendResult11_g114 , appendResult19_g114 ) );
			float4 weightedBlendVar92 = temp_output_81_0;
			float3 weightedAvg92 = ( ( weightedBlendVar92.x*( ( normalizeResult15_g113 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) + weightedBlendVar92.y*( ( normalizeResult15_g115 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) + weightedBlendVar92.z*( ( normalizeResult15_g116 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) + weightedBlendVar92.w*( ( normalizeResult15_g114 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) )/( weightedBlendVar92.x + weightedBlendVar92.y + weightedBlendVar92.z + weightedBlendVar92.w ) );
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;164;1258.334,-173.4329;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;MTE/Standard/Experimental/Packed/4Textures;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.FunctionNode;165;145.9654,457.4018;Inherit;False;GetNormalsFromPackedHeight;-1;;112;e838e220bfb1a834390a94fca7b1804b;0;3;128;FLOAT;3;False;102;SAMPLER2D;0;False;94;FLOAT2;0,0;False;4;FLOAT3;124;FLOAT3;50;FLOAT3;109;FLOAT3;110
...
WireConnection;92;1;165;124
WireConnection;92;2;165;50
WireConnection;92;3;165;109
WireConnection;92;4;165;110
...
WireConnection;164;0;70;0
WireConnection;164;1;92;0
WireConnection;164;3;141;0
WireConnection;164;4;140;0
WireConnection;165;128;149;0
WireConnection;165;102;83;0
WireConnection;165;94;85;0
ASEEND*/
//CHKSM=8E380D7018F20FD409A38DBEF3D68C5413A6E28E