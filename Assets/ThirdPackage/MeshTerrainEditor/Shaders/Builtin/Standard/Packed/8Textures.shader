...
#define _SmoothnessExtra_arr MTEStandardExperimentalPacked8Textures
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_21_0_g262 = tex2DNode100_g259.g;
			float temp_output_22_0_g262 = temp_output_128_0_g259;
			float3 appendResult11_g262 = (float3(1.0 , 0.0 , ( ( tex2DNode97_g259.g - temp_output_21_0_g262 ) * temp_output_22_0_g262 )));
			float3 appendResult19_g262 = (float3(0.0 , 0.5 , ( ( tex2DNode98_g259.g - temp_output_21_0_g262 ) * temp_output_22_0_g262 )));
			float3 normalizeResult15_g262 = normalize( cross( appendResult11_g262 , appendResult19_g262 ) );
			float temp_output_21_0_g263 = tex2DNode100_g259.b;
			float temp_output_22_0_g263 = temp_output_128_0_g259;
			float3 appendResult11_g263 = (float3(1.0 , 0.0 , ( ( tex2DNode97_g259.b - temp_output_21_0_g263 ) * temp_output_22_0_g263 )));
			float3 appendResult19_g263 = (float3(0.0 , 0.5 , ( ( tex2DNode98_g259.b - temp_output_21_0_g263 ) * temp_output_22_0_g263 )));
			float3 normalizeResult15_g263 = normalize( cross( appendResult11_g263 , appendResult19_g263 ) );
			float temp_output_21_0_g261 = tex2DNode100_g259.a;
			float temp_output_22_0_g261 = temp_output_128_0_g259;
			float3 appendResult11_g261 = (float3(1.0 , 0.0 , ( ( tex2DNode97_g259.a - temp_output_21_0_g261 ) * temp_output_22_0_g261 )));
			float3 appendResult19_g261 = (float3(0.0 , 0.5 , ( ( tex2DNode98_g259.a - temp_output_21_0_g261 ) * temp_output_22_0_g261 )));
			...
			float3 weightedAvg287 = ( ( weightedBlendVar287.x*( ( normalizeResult15_g260 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) + weightedBlendVar287.y*( ( normalizeResult15_g262 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) + weightedBlendVar287.z*( ( normalizeResult15_g263 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) + weightedBlendVar287.w*( ( normalizeResult15_g261 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) )/( weightedBlendVar287.x + weightedBlendVar287.y + weightedBlendVar287.z + weightedBlendVar287.w ) );
			...
			float2 temp_output_94_0_g264 = uv_PackedHeightMapExtra;
			float2 appendResult99_g264 = (float2(_PackedHeightMapExtra_TexelSize.x , 0.0));
			float4 tex2DNode97_g264 = tex2D( _PackedHeightMapExtra, ( temp_output_94_0_g264 + appendResult99_g264 ) );
			float4 tex2DNode100_g264 = tex2D( _PackedHeightMapExtra, temp_output_94_0_g264 );
			float temp_output_21_0_g265 = tex2DNode100_g264.r;
			float temp_output_128_0_g264 = _NormalStrengthExtra.x;
			float temp_output_22_0_g265 = temp_output_128_0_g264;
			float3 appendResult11_g265 = (float3(1.0 , 0.0 , ( ( tex2DNode97_g264.r - temp_output_21_0_g265 ) * temp_output_22_0_g265 )));
			float2 appendResult101_g264 = (float2(0.0 , _PackedHeightMapExtra_TexelSize.y));
			float4 tex2DNode98_g264 = tex2D( _PackedHeightMapExtra, ( temp_output_94_0_g264 + appendResult101_g264 ) );
			float3 appendResult19_g265 = (float3(0.0 , 0.5 , ( ( tex2DNode98_g264.r - temp_output_21_0_g265 ) * temp_output_22_0_g265 )));
			float3 normalizeResult15_g265 = normalize( cross( appendResult11_g265 , appendResult19_g265 ) );
			float temp_output_21_0_g267 = tex2DNode100_g264.g;
			float temp_output_22_0_g267 = temp_output_128_0_g264;
			float3 appendResult11_g267 = (float3(1.0 , 0.0 , ( ( tex2DNode97_g264.g - temp_output_21_0_g267 ) * temp_output_22_0_g267 )));
			float3 appendResult19_g267 = (float3(0.0 , 0.5 , ( ( tex2DNode98_g264.g - temp_output_21_0_g267 ) * temp_output_22_0_g267 )));
			float3 normalizeResult15_g267 = normalize( cross( appendResult11_g267 , appendResult19_g267 ) );
			float temp_output_21_0_g268 = tex2DNode100_g264.b;
			float temp_output_22_0_g268 = temp_output_128_0_g264;
			float3 appendResult11_g268 = (float3(1.0 , 0.0 , ( ( tex2DNode97_g264.b - temp_output_21_0_g268 ) * temp_output_22_0_g268 )));
			float3 appendResult19_g268 = (float3(0.0 , 0.5 , ( ( tex2DNode98_g264.b - temp_output_21_0_g268 ) * temp_output_22_0_g268 )));
			float3 normalizeResult15_g268 = normalize( cross( appendResult11_g268 , appendResult19_g268 ) );
			float temp_output_21_0_g266 = tex2DNode100_g264.a;
			float temp_output_22_0_g266 = temp_output_128_0_g264;
			float3 appendResult11_g266 = (float3(1.0 , 0.0 , ( ( tex2DNode97_g264.a - temp_output_21_0_g266 ) * temp_output_22_0_g266 )));
			float3 appendResult19_g266 = (float3(0.0 , 0.5 , ( ( tex2DNode98_g264.a - temp_output_21_0_g266 ) * temp_output_22_0_g266 )));
			float3 normalizeResult15_g266 = normalize( cross( appendResult11_g266 , appendResult19_g266 ) );
			float4 weightedBlendVar322 = temp_output_312_0;
			float3 weightedAvg322 = ( ( weightedBlendVar322.x*( ( normalizeResult15_g265 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) + weightedBlendVar322.y*( ( normalizeResult15_g267 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) + weightedBlendVar322.z*( ( normalizeResult15_g268 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) + weightedBlendVar322.w*( ( normalizeResult15_g266 * 0.5 ) + float3( 0.5,0.5,0.5 ) ) )/( weightedBlendVar322.x + weightedBlendVar322.y + weightedBlendVar322.z + weightedBlendVar322.w ) );
...
Node;AmplifyShaderEditor.FunctionNode;315;-505.7572,2684.75;Inherit;False;GetNormalsFromPackedHeight;-1;;264;e838e220bfb1a834390a94fca7b1804b;0;3;128;FLOAT;3;False;102;SAMPLER2D;0;False;94;FLOAT2;0,0;False;4;FLOAT3;124;FLOAT3;50;FLOAT3;109;FLOAT3;110
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;129;981.7219,1843.476;Float;False;True;-1;2;MTE.MTEPackedShaderGUI;0;0;Standard;MTE/Standard/Experimental/Packed/8Textures;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=A964B9B9BF7F38F86B7BAF47AF8BD18F95F89145