...
[CreateAssetMenu(menuName = "TerrainSplat/Layer Config", order = -10)]
[ExecuteInEditMode]
public class TextureArrayConfig : ScriptableObject
{
    public string splatmapFolder = "Assets/ArtRes/Terrain/Texture/";
    public string matFolder = "Assets/ArtRes/Terrain/Material/";
    ...
    [HideInInspector]
    public PackingQuality packingQuality = PackingQuality.Fastest;

    [HideInInspector]
    public int hash;
    

    public int atlasDilation = 2;
    public enum AtlasLayout
    {
        K_2x2=2,
        K_4x4=4
    }
    public AtlasLayout atlasLayout = AtlasLayout.K_4x4;
    ...
    #if UNITY_EDITOR
    public static List<T> FindAssetsByType<T>() where T : 
        UnityEngine.Object
    {
    ...
    public Texture2D diffuseHeightAtlas;
    public Texture2D normalSAOAtlas;
    public Texture2D smoothAOAtlas;
    public Texture2D antiTileAtlas;
    public Texture2D emisAtlas;
    public PackingMode packingMode = PackingMode.Array;
