...
namespace Oddworm.EditorFramework
{
    ...
    public class Texture2DArrayImporter : ScriptedImporter
    {
        ...
        /// </summary>
        public const string kFileExtension = "texarray";
        ...
        public static void CreateTexture2DArray(string path)
        {
            AssetDatabase.CreateAsset(new Texture2DArray(1,1,1,DefaultFormat.LDR, TextureCreationFlags.None), path);
