...
namespace UberEffect
{
    ...
    public class MaterialEditorUtility
    {
        ...
        public static EMaterialBlendMode CheckBlendMode(MaterialProperty dstBlend, MaterialProperty zWrite)
        {
            if (zWrite.floatValue == 1)
            {
                // Opaque
                return EMaterialBlendMode.Opaque;
            }

            if (dstBlend.floatValue == (int) BlendMode.One)
                return EMaterialBlendMode.Add;
            return EMaterialBlendMode.Blend;
        }
        ...
        public static void TransparentSwitchButtonDraw(MaterialProperty srcBlend, MaterialProperty dstBlend, MaterialProperty zWrite)
        {
            ...
            var Bmode = CheckBlendMode(dstBlend, zWrite);
            EditorGUI.BeginChangeCheck();
            Bmode = (EMaterialBlendMode)EditorGUILayout.EnumPopup("BlendMode",Bmode);
