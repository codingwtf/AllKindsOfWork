...
namespace UberEffect
{
    public class UberEffectMateiralInspector : ShaderGUI
    {
        ...
        private MaterialProperty _MainTexAlphaChannel;
        ...
        private MaterialProperty _MaskTimeUVX;
        private MaterialProperty _MaskTimeUVY;
        ...
        private MaterialProperty _VertTimeUVX;
        private MaterialProperty _VertTimeUVY;
        ...
        void SetProperties(MaterialProperty[] properties)
        {
            ...
            _MainTexAlphaChannel = FindProperty(UberEffectPropertyNames.MainTexAlphaChannel);
            ...
            _MaskTimeUVX = FindProperty(UberEffectPropertyNames.MaskTimeUVX);
            _MaskTimeUVY = FindProperty(UberEffectPropertyNames.MaskTimeUVY);
            ...
            _VertTimeUVX = FindProperty(UberEffectPropertyNames.VertTimeUVX);
            _VertTimeUVY = FindProperty(UberEffectPropertyNames.VertTimeUVY);
            ...
            _ZTest = FindProperty(UberEffectPropertyNames.ZTest);
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            MaterialEditorUtility.DrawEnumProperty<CompareFunction>(m_materialEditor, "深度测试ZTest", _ZTest);
        ...
        void InitFoldoutGroup()
        {
            ...
            m_foldoutGroup["MaskTex"] = new foldoutGroupState()
            {
                display = false,
                haveKeyword = true,
                keywordName = "MASKTEX_ENABLED",
                keywordProperty = _EnableMaskTex,
            ...
            m_foldoutGroup["DissolveMap"] = new foldoutGroupState()
            {
                display = false,
                haveKeyword = true,
                keywordName = "DISSOLVE_ENABLED",
                keywordProperty = _EnableDissolve,
            ...
            m_foldoutGroup["FlowMap"] = new foldoutGroupState()
            {
                display = false,
                haveKeyword = true,
                keywordName = "FLOWMAP_ENABLED",
                keywordProperty = _EnableFlowMap,
            ...
            m_foldoutGroup["Rim"] = new foldoutGroupState()
            {
                display = false,
                haveKeyword = true,
                keywordName = "RIM_EFFECT_ENABLED",
                keywordProperty = _EnableRim,
            ...
            m_foldoutGroup["VertDisplacement"] = new foldoutGroupState()
            {
                display = false,
                haveKeyword = true,
                keywordName = "VERTEX_DISPLACEMENT_ENABLED",
                keywordProperty = _EnableVertexDisplacement,
            ...
            m_foldoutGroup["AlphaClip"] = new foldoutGroupState()
            {
                display = false,
                haveKeyword = true,
                keywordName = "ALPHA_CLIP_ENABLED",
                keywordProperty = _EnableAlphaClip,
            ...
            m_foldoutGroup["SoftParicle"] = new foldoutGroupState()
            {
                display = false,
                haveKeyword = true,
                keywordName = "SOFT_PARTICLES_ENABLED",
                keywordProperty = _EnableSoftParticle,
            ...
            m_foldoutGroup["SceneLighting"] = new foldoutGroupState()
            {
                display = false,
                haveKeyword = true,
                keywordName = "SCENE_LIGHTING_ENABLED",
                keywordProperty = _EnableSceneLighting,
        ...
        void DrawMainTexProperties()
        {
            ...
            MaterialEditorUtility.DrawEnumProperty<EMainTexAlphaBlend>(m_materialEditor, "主贴图明通道选择", _MainTexAlphaChannel);
        ...
        {
            MaterialEditorUtility.DrawTexture(m_materialEditor, _MaskTex, true, _MaskTexOffsetCoordX, _MaskTexOffsetCoordY,_MaskTimeUVX,_MaskTimeUVY);
        ...
        {    
            MaterialEditorUtility.DrawTexture(m_materialEditor, _VertDisplaceMap, true, _VertDisplaceTexOffsetCoordX, _VertDisplaceTexOffsetCoordY, _VertTimeUVX, _VertTimeUVY);
