Shader "Spark/Effects/EffectMix"
{
    Properties
    {
        [HDR] _TintColor("Tint Color", Color) = (1,1,1,1)
        _MainTex ("Main Texture", 2D) = "white" {}
        [Enum(UberEffect.EMainTexAlphaBlend)]_MainTexAlpha("MainTexAlpha",float) = 0
        ...
        _MaskTimeUVX("_MaskTimeUVX",float) = 0
        _MaskTimeUVY("_MaskTimeUVY",float) = 0
        ...
        _VertTimeUVX("_VertTimeUVX",float) = 0
        _VertTimeUVY("_VertTimeUVY",float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes input)
            {
                ...
                output.mainAndMaskUV.zw += maskUVOffset + frac(_Time.x * float2(_MaskTimeUVX,_MaskTimeUVY));
                ...
                //vert displacement
                    ...
                    vertDisplaceUV += vertDisplaceUVOffset + frac(_Time.x * float2(_VertTimeUVX,_VertTimeUVY));
                    half4 vertDisplaceMapCol = tex2Dlod(_VertDisplaceMap, float4(vertDisplaceUV, 0, 0));
                        ...
                        half maskCol = tex2Dlod(_MaskTex, half4(output.mainAndMaskUV.zw, 0, 0)).r;
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                mainCol.a = lerp(mainCol.a,mainCol.r,_MainTexAlpha);
                ...
                //MaskTex
                #if defined(MASKTEX_ENABLED)
                    half maskCol = tex2D(_MaskTex, input.mainAndMaskUV.zw).r;
