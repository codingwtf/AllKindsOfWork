...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class GaussianBlurRenderer : VolumeRenderer<GaussianBlur>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Blur/GaussianBlur");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            {
                // horizontal blur
                m_BlitMaterial.SetVector(ShaderIDs.BlurRadius, new Vector4(volumeSettings.BlurRadius.value / Screen.width, 0, 0, 0));
                cmd.Blit(ShaderIDs.BufferRT1, ShaderIDs.BufferRT2, m_BlitMaterial);

                // vertical blur
                m_BlitMaterial.SetVector(ShaderIDs.BlurRadius, new Vector4(0, volumeSettings.BlurRadius.value / Screen.height, 0, 0));
