...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class GrainyBlurRenderer : VolumeRenderer<GrainyBlur>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Blur/GrainyBlur");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector2(volumeSettings.BlurRadius.value / Screen.height, volumeSettings.Iteration.value));
