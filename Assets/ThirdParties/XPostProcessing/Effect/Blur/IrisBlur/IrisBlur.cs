...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public sealed class IrisBlurRenderer : VolumeRenderer<IrisBlur>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Blur/IrisBlur");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            if (volumeSettings.Iteration == 1)
            {
                HandleOneBlitBlur(cmd, source, target);
            }
            else
            {
                HandleMultipleIterationBlur(cmd, source, target, volumeSettings.Iteration.value);
            }
        ...
        void HandleOneBlitBlur(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            // Set Property
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector4(volumeSettings.AreaSize.value, volumeSettings.BlurRadius.value));

            cmd.Blit(source, ShaderIDs.BufferRT1, m_BlitMaterial, (int)volumeSettings.QualityLevel.value);
        ...
        void HandleMultipleIterationBlur(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target, int Iteration)
        {
            ...
            // Set Property
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector2(volumeSettings.AreaSize.value, volumeSettings.BlurRadius.value));
            ...
            {
                // Do Blit
                cmd.Blit(firstID, secondID, m_BlitMaterial, (int)volumeSettings.QualityLevel.value);
