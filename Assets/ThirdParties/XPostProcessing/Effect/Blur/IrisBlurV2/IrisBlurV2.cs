...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public sealed class IrisBlurV2Renderer : VolumeRenderer<IrisBlurV2>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Blur/IrisBlurV2");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Gradient, new Vector3(volumeSettings.centerOffsetX.value, volumeSettings.centerOffsetY.value, volumeSettings.AreaSize.value * 0.1f));
            ...
            cmd.Blit(source, target, m_BlitMaterial, volumeSettings.showPreview.value ? 1 : 0);
