...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class KawaseBlurRenderer : VolumeRenderer<KawaseBlur>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Blur/KawaseBlur");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            {
                m_BlitMaterial.SetFloat(ShaderIDs.BlurRadius, i / volumeSettings.RTDownScaling.value + volumeSettings.BlurRadius.value);
            ...
            m_BlitMaterial.SetFloat(ShaderIDs.BlurRadius, volumeSettings.Iteration.value / volumeSettings.RTDownScaling.value + volumeSettings.BlurRadius.value);
