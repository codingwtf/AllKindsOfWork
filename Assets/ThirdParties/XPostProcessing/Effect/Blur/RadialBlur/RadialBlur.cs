...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class RadialBlurRenderer : VolumeRenderer<RadialBlur>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Blur/RadialBlur");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector4(volumeSettings.BlurRadius.value * 0.02f, volumeSettings.Iteration.value, volumeSettings.RadialCenterX.value, volumeSettings.RadialCenterY.value));
