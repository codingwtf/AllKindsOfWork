...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class ColorAdjustmentContrastV2Renderer : VolumeRenderer<ColorAdjustmentContrastV2>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/ColorAdjustment/ContrastV2");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetFloat(ShaderIDs.Contrast, volumeSettings.contrast.value + 1f);
            m_BlitMaterial.SetVector(ShaderIDs.ContrastFactorRGB, new Vector3(volumeSettings.ContrastFactorR.value, volumeSettings.ContrastFactorG.value, volumeSettings.ContrastFactorB.value));
