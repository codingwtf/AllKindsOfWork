...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class ColorAdjustmentTechnicolorRenderer : VolumeRenderer<ColorAdjustmentTechnicolor>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/ColorAdjustment/Technicolor");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetFloat(ShaderIDs.exposure, 8f - volumeSettings.exposure.value);
            m_BlitMaterial.SetVector(ShaderIDs.colorBalance, Vector3.one - new Vector3(volumeSettings.colorBalanceR.value, volumeSettings.colorBalanceG.value, volumeSettings.colorBalanceB.value));
            m_BlitMaterial.SetFloat(ShaderIDs.indensity, volumeSettings.indensity.value);
