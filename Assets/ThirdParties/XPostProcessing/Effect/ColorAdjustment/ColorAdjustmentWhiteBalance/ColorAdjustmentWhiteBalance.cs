...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class ColorAdjustmentWhiteBalanceRenderer : VolumeRenderer<ColorAdjustmentWhiteBalance>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/ColorAdjustment/WhiteBalance");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetFloat(ShaderIDs.Temperature, volumeSettings.temperature.value);
            m_BlitMaterial.SetFloat(ShaderIDs.Tint, volumeSettings.tint.value);
