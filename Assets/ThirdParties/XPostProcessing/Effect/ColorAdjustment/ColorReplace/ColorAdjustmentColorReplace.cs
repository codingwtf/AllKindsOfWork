...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class ColorAdjustmentColorReplaceRenderer : VolumeRenderer<ColorAdjustmentColorReplace>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/ColorAdjustment/ColorReplace");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetColor(ShaderIDs.FromColor, volumeSettings.FromColor.value);
            m_BlitMaterial.SetColor(ShaderIDs.ToColor, volumeSettings.ToColor.value);
