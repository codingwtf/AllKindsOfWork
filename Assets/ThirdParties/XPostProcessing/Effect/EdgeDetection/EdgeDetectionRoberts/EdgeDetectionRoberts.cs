...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public sealed class EdgeDetectionRobertsRenderer : VolumeRenderer<EdgeDetectionRoberts>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/EdgeDetection/Roberts");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector2(volumeSettings.edgeWidth.value, volumeSettings.backgroundFade.value));
            m_BlitMaterial.SetColor(ShaderIDs.EdgeColor, volumeSettings.edgeColor.value);
