...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class DepthFogRenderer : VolumeRenderer<DepthFog>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/DepthFog");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetColor(ShaderContants.fogColorID, volumeSettings.fogColor.value);
            Vector4 fogParam;
            fogParam.x = volumeSettings.fogStrength.value;
            fogParam.y = volumeSettings.fogHeightScale.value;
            fogParam.z = volumeSettings.fogEnableDistance.value;
            fogParam.w = volumeSettings.fogEnableDistanceArea.value;
            m_BlitMaterial.SetVector(ShaderContants.fogParameterID, fogParam);
            m_BlitMaterial.SetFloat(ShaderContants.fogBaseLevelID, volumeSettings.fogBaseLevel.value);
