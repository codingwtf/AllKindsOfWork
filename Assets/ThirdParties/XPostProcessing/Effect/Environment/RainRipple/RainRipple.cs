...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class RainRippleRenderer : VolumeRenderer<RainRippel>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/RainRipple");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetTexture(ShaderContants.rainRippleMaskTextureID, volumeSettings.rippleMaskTexture.value);
            m_BlitMaterial.SetTexture(ShaderContants.rainFlowMapID, volumeSettings.flowMap.value);
            m_BlitMaterial.SetTexture(ShaderContants.rainFlowNormalID, volumeSettings.flowNormalMap.value);
            m_BlitMaterial.SetFloat(ShaderContants.rainRippleStrengthID, volumeSettings.rippleStrength.value);
            m_BlitMaterial.SetVector(ShaderContants.texelSizeID, texelS);
            m_BlitMaterial.SetFloat(ShaderContants.rainRippleDiffusionFrequencyID, volumeSettings.rippleFrequency.value);
            m_BlitMaterial.SetFloat(ShaderContants.rainRippleSizeID, volumeSettings.rippleSize.value);
            m_BlitMaterial.SetFloat(ShaderContants.rainIntensityID, volumeSettings.rainIntensity.value);
            m_BlitMaterial.SetFloat(ShaderContants.rainRippleBiasID, volumeSettings.rippleBias.value);
            m_BlitMaterial.SetFloat(ShaderContants.rainFlowStrengthID, volumeSettings.flowStrength.value);
            m_BlitMaterial.SetFloat(ShaderContants.rainFlowSpeedID, volumeSettings.flowSpeed.value);
            m_BlitMaterial.SetFloat(ShaderContants.rainEnableDistanceID, volumeSettings.rainEnableDistance.value);
