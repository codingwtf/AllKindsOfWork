...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class GlitchAnalogNoiseRenderer : VolumeRenderer<GlitchAnalogNoise>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Glitch/AnalogNoise");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector4(volumeSettings.NoiseSpeed.value, volumeSettings.NoiseFading.value, volumeSettings.LuminanceJitterThreshold.value, TimeX));
