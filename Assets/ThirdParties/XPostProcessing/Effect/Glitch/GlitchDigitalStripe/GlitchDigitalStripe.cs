...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class GlitchDigitalStripeRenderer : VolumeRenderer<GlitchDigitalStripe>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Glitch/DigitalStripe");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            UpdateNoiseTexture(volumeSettings.frequncy.value, volumeSettings.noiseTextureWidth.value, volumeSettings.noiseTextureHeight.value, volumeSettings.stripeLength.value);

            m_BlitMaterial.SetFloat(ShaderIDs.indensity, volumeSettings.intensity.value);
            ...
            if (volumeSettings.needStripColorAdjust == true)
            {
                m_BlitMaterial.EnableKeyword("NEED_TRASH_FRAME");
                m_BlitMaterial.SetColor(ShaderIDs.StripColorAdjustColor, volumeSettings.StripColorAdjustColor.value);
                m_BlitMaterial.SetFloat(ShaderIDs.StripColorAdjustIndensity, volumeSettings.StripColorAdjustIndensity.value);
            }
            else
            {
