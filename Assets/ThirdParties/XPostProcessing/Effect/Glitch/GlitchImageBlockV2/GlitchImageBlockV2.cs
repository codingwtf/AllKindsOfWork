...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class GlitchImageBlockV2Renderer : VolumeRenderer<GlitchImageBlockV2>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Glitch/ImageBlockV2");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params2, new Vector4(volumeSettings.BlockLayer1_U.value, volumeSettings.BlockLayer1_V.value, volumeSettings.BlockLayer1_Indensity.value, volumeSettings.RGBSplitIndensity.value));
