...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class GlitchImageBlockV3Renderer : VolumeRenderer<GlitchImageBlockV3>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Glitch/ImageBlockV3");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector2(volumeSettings.Speed.value, volumeSettings.BlockSize.value));
