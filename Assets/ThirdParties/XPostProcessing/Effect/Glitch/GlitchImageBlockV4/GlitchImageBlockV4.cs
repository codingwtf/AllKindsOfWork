...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class GlitchImageBlockV4Renderer : VolumeRenderer<GlitchImageBlockV4>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Glitch/ImageBlockV4");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector4(volumeSettings.Speed.value, volumeSettings.BlockSize.value, volumeSettings.MaxRGBSplitX.value, volumeSettings.MaxRGBSplitY.value));
