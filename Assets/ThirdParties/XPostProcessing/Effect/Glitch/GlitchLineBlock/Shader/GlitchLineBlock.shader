...
Shader "Hidden/PostProcessing/Glitch/LineBlock"
{
    ...
    //新增随机色开关
    #define  _RandomColor _Params2.w
    ...
    float4 Frag_Horizontal(VaryingsDefault i): SV_Target
    {
        ...
        //新增调色开关
        float4 RandomColorFianl = lerp(blockLineColor, float4(blockLineColor_rgb, blockLineColor.a), _RandomColor);
        // [5] 与源场景图进行混合
        float4 sceneColor = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.uv);
        return lerp(sceneColor, RandomColorFianl, _Alpha);
    }
