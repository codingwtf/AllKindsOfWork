...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public sealed class GlitchRGBSplitRenderer : VolumeRenderer<GlitchRGBSplit>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Glitch/RGBSplit");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector4(volumeSettings.Fading.value, volumeSettings.Amount.value, volumeSettings.Speed.value, volumeSettings.CenterFading.value));
            m_BlitMaterial.SetVector(ShaderIDs.Params2, new Vector3(TimeX, volumeSettings.AmountR.value, volumeSettings.AmountB.value));
