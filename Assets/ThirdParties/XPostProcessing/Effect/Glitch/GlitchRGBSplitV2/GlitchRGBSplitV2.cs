...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public sealed class GlitchRGBSplitV2Renderer : VolumeRenderer<GlitchRGBSplitV2>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Glitch/RGBSplitV2");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector3(TimeX * volumeSettings.Speed.value, volumeSettings.Amount.value, volumeSettings.Amplitude.value));
