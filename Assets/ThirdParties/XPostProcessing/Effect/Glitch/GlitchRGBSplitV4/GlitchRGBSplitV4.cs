...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public sealed class GlitchRGBSplitV4Renderer : VolumeRenderer<GlitchRGBSplitV4>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Glitch/RGBSplitV4");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector2(volumeSettings.indensity.value * 0.1f, Mathf.Floor(TimeX * volumeSettings.speed.value)));
