...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class GlitchScreenJumpRenderer : VolumeRenderer<GlitchScreenJump>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Glitch/ScreenJump");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            ScreenJumpTime += Time.deltaTime * volumeSettings.ScreenJumpIndensity.value * 9.8f;
            Vector2 ScreenJumpVector = new Vector2(volumeSettings.ScreenJumpIndensity.value, ScreenJumpTime);

            m_BlitMaterial.SetVector(ShaderIDs.Params, ScreenJumpVector);

            cmd.Blit(source, target, m_BlitMaterial, (int)volumeSettings.ScreenJumpDirection.value);
