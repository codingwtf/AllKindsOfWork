...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class GlitchScreenShakeRenderer : VolumeRenderer<GlitchScreenShake>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Glitch/ScreenShake");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetFloat(ShaderIDs.ScreenShakeIndensity, volumeSettings.ScreenShakeIndensity.value * 0.25f);
            cmd.Blit(source, target, m_BlitMaterial, (int)volumeSettings.ScreenShakeDirection.value);
