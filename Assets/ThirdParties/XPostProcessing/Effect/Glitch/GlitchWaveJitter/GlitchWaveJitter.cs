...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public sealed class GlitchWaveJitterRenderer : VolumeRenderer<GlitchWaveJitter>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Glitch/WaveJitter");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector4(volumeSettings.intervalType.value == IntervalType.Random ? randomFrequency : volumeSettings.frequency.value
                   , volumeSettings.RGBSplit.value, volumeSettings.speed.value, volumeSettings.amount.value));
            m_BlitMaterial.SetVector(ShaderIDs.Resolution, volumeSettings.customResolution.value ? volumeSettings.resolution.value : new Vector2(Screen.width, Screen.height));
        ...
        void UpdateFrequency(GlitchWaveJitter volumeSettings)
        {
