...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class SharpenV3Renderer : VolumeRenderer<SharpenV3>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/ImageProcessing/SharpenV3");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetFloat(ShaderIDs.CentralFactor, 1.0f + (3.2f * volumeSettings.Sharpness.value));
            m_BlitMaterial.SetFloat(ShaderIDs.SideFactor, 0.8f * volumeSettings.Sharpness.value);
