...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class PixelizeHexagonGridRenderer : VolumeRenderer<PixelizeHexagonGrid>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Pixelate/PixelizeHexagonGrid");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector2(volumeSettings.pixelSize.value, volumeSettings.gridWidth.value));
