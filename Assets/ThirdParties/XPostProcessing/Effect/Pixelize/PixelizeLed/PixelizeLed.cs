...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class PixelizeLedRenderer : VolumeRenderer<PixelizeLed>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Pixelate/PixelizeLed");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.Params, new Vector4(size, ratio, volumeSettings.ledRadius.value));
