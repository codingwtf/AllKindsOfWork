...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class PixelizeSectorRenderer : VolumeRenderer<PixelizeSector>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Pixelate/PixelizeSector");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            float size = (1.01f - volumeSettings.pixelSize.value) * 300f;
            Vector4 parameters = new Vector4(size, ((Screen.width * 2 / Screen.height) * size / Mathf.Sqrt(3f)), volumeSettings.circleRadius.value, 0f);

            m_BlitMaterial.SetVector(ShaderIDs.Params, parameters);
            m_BlitMaterial.SetVector(ShaderIDs.Params2, new Vector2(volumeSettings.pixelIntervalX.value, volumeSettings.pixelIntervalY.value));
            m_BlitMaterial.SetColor("_BackgroundColor", volumeSettings.BackgroundColor.value);
