...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class SurfaceSnowRenderer : VolumeRenderer<SurfaceSnow>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/SurfaceSnow");
            m_BlitMaterial = CoreUtils.CreateEngineMaterial(shader);

            //shader2 = XPostProcessingFindShader.Find()
        }
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            RenderTexture temp1 = RenderTexture.GetTemporary(Screen.width / volumeSettings.blurInt.value, Screen.height / volumeSettings.blurInt.value);
            ...
            m_BlitMaterial.SetTexture(ShaderContants.snowTextureID, volumeSettings.snowTexture.value);
            m_BlitMaterial.SetFloat(ShaderContants.snowStrengthID, volumeSettings.snowStrength.value);
            m_BlitMaterial.SetFloat(ShaderContants.snowBiasID, volumeSettings.snowBias.value);
            m_BlitMaterial.SetFloat(ShaderContants.snowSizeID, volumeSettings.snowSize.value);
            m_BlitMaterial.SetFloat(ShaderContants.debugValueID, volumeSettings.debugValue.value);
            m_BlitMaterial.SetInt(ShaderContants.sampleOffsetID, volumeSettings.sampleOffset.value);
