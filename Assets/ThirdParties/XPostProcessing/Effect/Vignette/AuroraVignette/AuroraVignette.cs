...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class AuroraVignetteRenderer : VolumeRenderer<AuroraVignette>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Vignette/AuroraVignette");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetFloat(ShaderIDs.vignetteArea, volumeSettings.vignetteArea.value);
            m_BlitMaterial.SetFloat(ShaderIDs.vignetteSmothness, volumeSettings.vignetteSmothness.value);
            m_BlitMaterial.SetFloat(ShaderIDs.colorChange, volumeSettings.colorChange.value * 10f);
            m_BlitMaterial.SetVector(ShaderIDs.colorFactor, new Vector3(volumeSettings.colorFactorR.value, volumeSettings.colorFactorG.value, volumeSettings.colorFactorB.value));
            m_BlitMaterial.SetFloat(ShaderIDs.TimeX, TimeX * volumeSettings.flowSpeed.value);
            m_BlitMaterial.SetFloat(ShaderIDs.vignetteFading, volumeSettings.vignetteFading.value);
