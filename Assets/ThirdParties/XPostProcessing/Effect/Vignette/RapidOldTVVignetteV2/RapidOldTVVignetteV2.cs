...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class RapidOldTVVignetteV2Renderer : VolumeRenderer<RapidOldTVVignetteV2>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Vignette/RapidOldTVVignetteV2");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetFloat(ShaderIDs.VignetteSize, volumeSettings.vignetteSize.value);
            m_BlitMaterial.SetFloat(ShaderIDs.SizeOffset, volumeSettings.sizeOffset.value);
            if (volumeSettings.vignetteType.value == VignetteType.ColorMode)
            {
                m_BlitMaterial.SetColor(ShaderIDs.VignetteColor, volumeSettings.vignetteColor.value);
            }
