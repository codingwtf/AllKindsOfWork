...
namespace IGG.Rendering.XPostProcessing
{
    ...
    public class RapidVignetteV2Renderer : VolumeRenderer<RapidVignetteV2>
    {
        ...
        {
            shader = FindShader.Find("Hidden/PostProcessing/Vignette/RapidVignetteV2");
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target)
        {
            ...
            m_BlitMaterial.SetFloat(ShaderIDs.VignetteIndensity, volumeSettings.vignetteIndensity.value);
            m_BlitMaterial.SetVector(ShaderIDs.VignetteCenter, volumeSettings.vignetteCenter.value);
            m_BlitMaterial.SetFloat(ShaderIDs.VignetteSharpness, volumeSettings.vignetteSharpness.value);

            if (volumeSettings.vignetteType.value == VignetteType.ColorMode)
            {
                m_BlitMaterial.SetVector(ShaderIDs.VignetteColor, volumeSettings.vignetteColor.value);
            }

            cmd.Blit(source, target, m_BlitMaterial, (int)volumeSettings.vignetteType.value);
